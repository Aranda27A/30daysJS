    ...
    const mayores = inventors.filter( (person) =>  person.year >= 1500 && person.year <= 1600 )
    console.log(mayores);
    ...
    const sumAge = inventors.reduce((acc , total) => acc +(total.passed - total.year)  , 0)
    console.table(sumAge);
